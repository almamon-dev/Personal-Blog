                    ...
                    children: [
                        {
                            ...
                            path: "/admin/settings/website/system",
                        },
                        {
                            label: "Company Settings",
                            path: "/admin/settings/website/company",
                        },
                        {
                            label: "Localization",
                            path: "/admin/settings/website/localization",
                        },
                        {
                            label: "Prefixes",
                            path: "/admin/settings/website/prefixes",
                        },
                        {
                            label: "Preference",
                            path: "/admin/settings/website/preference",
                        },
                        {
                            label: "Appearance",
                        ...
                        },
                        {
                            ...
                            path: "/admin/settings/website/social-auth",
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            label: "Email",
                            path: "/admin/settings/system/email",
                        },
                        { label: "SMS", path: "/admin/settings/system/sms" },
                        { label: "OTP", path: "/admin/settings/system/otp" },
                        {
                            label: "GDPR Cookies",
                            path: "/admin/settings/system/gdpr",
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            ...
                            path: "/admin/settings/financial/gateway",
                        },
                        {
                            label: "Bank Accounts",
                            path: "/admin/settings/financial/bank-accounts",
                        },
                        {
                            label: "Tax Rates",
                            path: "/admin/settings/financial/tax-rates",
                        },
                        {
                            label: "Currencies",
                            path: "/admin/settings/financial/currencies",
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            label: "Storage",
                            path: "/admin/settings/other/storage",
                        },
                        {
                            label: "Ban IP Address",
                            path: "/admin/settings/other/ban-ip",
                        },
                    ],
                },
                {
    ...
    const renderMenuItem = (item) => {
        ...
        const content = (
            <>
                ...
                {!isCollapsed && (
                    <span
                        className={`leading-tight transition-all duration-300 text-[14px] flex-1 text-left
